      ...
      <div class="flex-1 w-full">
        <div class="mb-12">
          <Carousel class="relative w-full">
            ...
            <CarouselPrevious class="left-4 bg-black/50 hover:bg-primary hover:cursor-pointer text-white border-white/20" />
            <CarouselNext class="right-4 bg-black/50 hover:bg-primary hover:cursor-pointer text-white border-white/20" />
          </Carousel>
        </div>
    ...
    <div class="lg:hidden fixed bottom-0 left-0 right-0 z-50">
      <Sheet>
        <SheetTrigger as-child>
          <Button class="w-full rounded-none bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-6 flex items-center justify-center gap-2">
            <ChevronUp class="w-5 h-5" />
            Informations du projet
          </Button>
        </SheetTrigger>
        <SheetContent side="bottom" class="h-[80vh] overflow-y-auto bg-background border-t border-border">
